...
from src.machine.utils.hu_moments_generation import hu_moments_of_file, hu_moments_of_contour, hu_moments_of_frame
from src.machine.utils.label_converters import int_to_label, label_formatter
...
def predict_contour(model, contour):
    ...
    return label_formatter(testResponse)
